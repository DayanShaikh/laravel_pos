!(function (t, e) {
    if ("function" == typeof define && define.amd)
        define(["moment", "jquery"], function (t, a) {
            return (
                a.fn || (a.fn = {}), "function" != typeof t && t.hasOwnProperty("default") && (t = t.default), e(t, a)
            );
        });
        ...
        (a.prototype = {
            ...
            updateMonthsInView: function () {
                if (this.endDate) {
                    if (
                        ...
                        (this.startDate.format("MM-YYYY") == this.leftCalendar.month.format("MM-YYYY") ||
                            this.startDate.format("MM-YYYY") == this.rightCalendar.month.format("MM-YYYY")) &&
                        (this.endDate.format("MM-YYYY") == this.leftCalendar.month.format("MM-YYYY") ||
                            this.endDate.format("MM-YYYY") == this.rightCalendar.month.format("MM-YYYY"))
                    )
                        return;
                    ...
                    this.leftCalendar.month.format("MM-YYYY") != this.startDate.format("MM-YYYY") &&
                        this.rightCalendar.month.format("MM-YYYY") != this.startDate.format("MM-YYYY") &&
                        ((this.leftCalendar.month = this.startDate.clone().date(2)),
                            (this.rightCalendar.month = this.startDate.clone().date(2).add(1, "month")));
                this.maxDate &&
                    this.linkedCalendars &&
                    ...
                    if (this.endDate) {
                        if (
                            ((t = parseInt(this.container.find(".left .hourselect").val(), 10)),
                                ...
                                isNaN(e) &&
                                (e = parseInt(this.container.find(".left .minuteselect option:last").val(), 10)),
            ...
            renderCalendar: function (a) {
                ...
                for (
                    ...
                    D > 0 && k % 7 == 0 && ((k = 0), b++),
                        ...
                        y.hour(12),
                        this.minDate &&
                        i[b][k].format("DD-MM-YYYY") == this.minDate.format("DD-MM-YYYY") &&
                        i[b][k].isBefore(this.minDate) &&
                        "left" == a &&
                        (i[b][k] = this.minDate.clone()),
                        this.maxDate &&
                        i[b][k].format("DD-MM-YYYY") == this.maxDate.format("DD-MM-YYYY") &&
            ...
            renderTimePicker: function (t) {
                if ("right" != t || this.endDate) {
                    ...
                    for (
                        var o = this.timePicker24Hour ? 0 : 1, h = this.timePicker24Hour ? 23 : 12, l = o;
                        l <= h;
                        l++
                    ) {
                        var c = l;
            ...
            hide: function (t) {
                this.isShowing &&
                    (this.endDate ||
                        ((this.startDate = this.oldStartDate.clone()), (this.endDate = this.oldEndDate.clone())),
                ...
                if (e(t.target).hasClass("available")) {
                    ...
                    if (this.endDate || n.isBefore(this.startDate, "day")) {
                        if (this.timePicker) {
                            ...
                            isNaN(o) &&
                                (o = parseInt(this.container.find(".left .minuteselect option:last").val(), 10));
                        ...
                        if (this.timePicker) {
                            ...
                            isNaN(o) &&
                                (o = parseInt(this.container.find(".right .minuteselect option:last").val(), 10));
