            ...
            <div class="mt-2 mt-sm-0 me-md-0 me-sm-4 me-sm-4 d-contents" id="navbar">
                <ul class="navbar-nav justify-content-end">
                    ...
                    <li class="nav-item d-xl-none ps-3 d-flex align-items-center">
                        <a href="#" class="p-0 nav-link text-body lh-1" id="iconNavbarSidenav">
                    ...
                    <li class="px-3 nav-item d-flex align-items-center"><a href="{{ route('config.index', 1)}}" title="Software Settings" class="p-0 nav-link lh-1 text-body"><i class="material-icons">settings</i></a></li>
                </ul>
            </div>
        </div>
    </div>
