                ...
                <div class="col-12">
                    <div class="card my-4">
                        ...
                        <div class=" me-3 my-3 text-end">
                            <a class="btn bg-gradient-dark mb-0" href="{{ route('config_variable.create')}}"><i class="material-icons text-sm">add</i></a>
                        </div>
                        <form method="POST" action="{{ route('config_variable.bulkAction') }}" id="myForm">
                            @csrf
                            @method('POST')
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="align-middle text-end px-4">
                                                    <a rel="tooltip" class="btn text-success btn-link pbtn fs-6 p-2" href="{{ route('config_variable.edit', $configs->id)}}" data-original-title="" title="">
                                                        <i class="material-icons">edit</i>
                                                        <div class="ripple-container"></div>
                                                    </a>
                                                    <a href="javascript:void(0)" id="delete-user" data-url="{{ route('config_variable.destroy', $configs->id) }}" class="btn text-danger btn-link pbtn fs-6 p-2" title="delete">
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="me-5 text-start ml-260">
                                ...
                                <form action="{{ route('config_variable.index') }}" method="get">
                                    @csrf
                                    <div class="input-group input-group-outline is-filled form-select d-inline-flex w-40">
                                        <span class="my-2 mx-1">Show Page:</span>
